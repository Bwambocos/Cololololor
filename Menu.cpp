...
// 更新
void Menu_Update() {
	if (CheckMouseIn(30, 150, 270, 360) == true) { F_frame1_M = true; F_sound1_M = true; before_M = 1; }
	if (CheckMouseIn(30, 150, 270, 360) == false) { F_frame1_M = false; F_sound1_M = false; before_M = -1; }
	if (CheckMouseClick(30, 150, 270, 360) == true) { SceneMgr_ChangeScene(Scene_Game1); }
	if (CheckMouseIn(370, 150, 570, 360) == true) { F_frame2_M = true; F_sound2_M = true; before_M = 2; }
	if (CheckMouseIn(370, 150, 610, 360) == false) { F_frame2_M = false; F_sound2_M = false; before_M = -1; }
